...
window.geometry('150*100')
window.configure(background="BLUE")

Tons=Frame(window,width=1350,height=50,bd=8,bg="pink")
Tops.pack()

f1=Frame(window,width=600,height=600,bd=8,bg="red")
f1.pack(side=LEFT)

f1=Frame(window,width=300,height=700,bd=8,bg="yellow")
f1.pack(side=RIGHT)
...
Iblinfo=Label(Tops,font=('arial',30,'bold'),text="Employee payroll system",bd=10,fg="green")
Iblinfo.grid(row=0,column=0)
...
def weeklywages():
    txtpayslip.delete("1.0", END)
    hoursworkedperweek=float(Hours Worked.get())
...
IblName=Label(fla,text="Name",font=('arial',16,'bold'),bd=20,fg="red",bg="powder blue").grid(row=0,column=0)
lblAddress=Label(fla,text="Address", font=('arial',16,'bold'),bd=20,fg="red",bg="powder blue").grid(row=0,column=2)
lblEmployer=Label(fla,text="Empolyer",font=('arial',16,'bold'),bd=20,fg="red",bg="powder blue").grid(row=1,column=0)
lbININumber=Label(fla,text="NI Number", font=('arial',16, 'bold'),bd=20,fg="red",bg="powder blue").grid(row=1,column=2)
IbiHoursWorked=Label(fla,text="Hours Worked", font=('arial',16, 'bold'),bd=20,fg="red",bg="powder blue").grid(row=2,column= 2)
IbIHourlyRate=Label(fla,text="Hourly Rate",font=('arial',16,'bold'),bd=20,fg="red",bg="powder blue").grid(row=2,column=2)
IbITax=Label(fla,text="Tax",font=('arial',16,'bold'), bd=20,anchor='w',fg="red",bg="powder blue").grid(row=3,column=0)
IblOverTime=Label(fla,text="OverTime", font=('arial',16,'bold'),bd=20,fg="red",,bg="powder blue").grid(row=3,column=2)
IblGrossPay=Label(fla,text="GrossPay", font=('arial', 16, 'bold'),bd=20,fg="red",bg="powder blue").grid(row=4,column=0)
...
etxaddress=Entry(fla,textvariable=Address,font=('arial',16,'bold',,od=16,width=22,justify='left')
etxaddress.grid(row=0,column=3)                 
etxemployer=Entry(fla,textvariable=Employer,font=('arial',16,'bold',,od=16,width=22,justify='left')
etxemployer.grid(row=1,column=1)
etxhoursworked=Entry(fla,textvariable=Hours Worked,font=('arial',16,'bold'),bd=16,width=22,justify='left')
